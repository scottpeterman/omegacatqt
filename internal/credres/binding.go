...
func shapesFor(id string) []shape {
	...
	// An address is indexed whole and never shortened -- with a port too,
	// which is how a port-forwarded device is dialed (127.0.0.1:2201).
	if a, ok := normalize.AddrOf(s); ok {
