...
REM nothing here uses cgo, so no C toolchain. The C surface and its probe
REM need mingw-w64 for cgo and a CMake toolchain, and build through the Qt
REM application's Windows script when that lands (step 3), as omegamaps does.
REM
