...
#ifndef OMEGACAT_APP_VAULTUNLOCKDIALOG_H
#define OMEGACAT_APP_VAULTUNLOCKDIALOG_H
...
public:
    ...
    explicit VaultUnlockDialog(omegacat::Vault *vault, QWidget *parent = nullptr);
    ...
    // no preamble.
    void setQuietResult(omegacat::VaultError code);
...
private:
    ...
    omegacat::KeyringStatus keyring_;
...
#endif  // OMEGACAT_APP_VAULTUNLOCKDIALOG_H