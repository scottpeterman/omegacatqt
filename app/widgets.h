...
#ifndef OMEGACAT_APP_WIDGETS_H
#define OMEGACAT_APP_WIDGETS_H
...
// A one-line label that, short of room, draws "start…end" instead of clipping.
// text() stays the whole string, and the tooltip shows it while elided. For a
// title in a bar that also holds buttons: clipped, "…/2026-09-16T13-51-12Z.txt"
// became "2026-09-167", which reads as a different file rather than a short one.
class ElidedLabel : public QLabel {
    Q_OBJECT
public:
    using QLabel::QLabel;
    QSize minimumSizeHint() const override { return {40, QLabel::minimumSizeHint().height()}; }
