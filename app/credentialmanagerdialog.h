...
#ifndef OMEGACAT_APP_CREDENTIALMANAGERDIALOG_H
#define OMEGACAT_APP_CREDENTIALMANAGERDIALOG_H
...
public:
    explicit CredentialManagerDialog(omegacat::Vault *vault, QWidget *parent = nullptr);
...
private:
    ...
    void report(const QString &action, omegacat::VaultError code);
    ...
    omegacat::CredentialMeta selected() const;

    omegacat::Vault *vault_ = nullptr;
    QVector<omegacat::CredentialMeta> rows_;
...
#endif  // OMEGACAT_APP_CREDENTIALMANAGERDIALOG_H
