...
#ifndef OMEGACAT_APP_CREDENTIALEDITORDIALOG_H
#define OMEGACAT_APP_CREDENTIALEDITORDIALOG_H
...
public:
    ...
    explicit CredentialEditorDialog(const omegacat::CredentialMeta &existing,
    ...
    omegacat::CredentialMeta metadata() const;
    ...
    // vault has taken it.
    omegacat::CredentialInput input() const;
...
private:
    ...
    omegacat::CredentialMeta existing_;
    bool adding_ = false;
...
#endif  // OMEGACAT_APP_CREDENTIALEDITORDIALOG_H
