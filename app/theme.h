...
//            fieldLabel, stat, statValue, statLabel, chip, log, canvas, notices,
//            labMatch (with state ok|fail|fallback), labCaption
...
#ifndef OMEGACAT_APP_THEME_H
#define OMEGACAT_APP_THEME_H
