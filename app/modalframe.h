// app/modalframe.h
//
// The shell every modal in OmegaCat is built inside (from Omega): an optional title strip, a
...
#ifndef OMEGACAT_APP_MODALFRAME_H
#define OMEGACAT_APP_MODALFRAME_H
...
#endif  // OMEGACAT_APP_MODALFRAME_Hvi